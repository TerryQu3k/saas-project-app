...
// call plan change handler so that the plan is set corrently in the drop down when the page loads
	handlePlanChange(GetURLParameter('plan'), ".cc_form");

// function to handle the token received form tripe and remove credit card fields
